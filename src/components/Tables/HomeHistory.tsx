                ...
                <Tr key={transaction.date} data-type="Tr">
                  <Td data-type="Td">
                    <Flex direction={'column'} gap={1}>
                      <Text fontSize={'md'} whiteSpace={'pre-wrap'} lineHeight={6}>
                        [{transaction.industry}] <strong>{transaction.account}</strong> -{' '}
                        {states.find((el) => el.value === transaction.state)?.label ||
                          transaction.state}
                      </Text>
